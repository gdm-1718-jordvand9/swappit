...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="/ticket_types" method="POST">
                @csrf
                ...
                <div class="form-row form-group">
                    <div class="col">
                        ...
                        <input class="form-control {{ $errors->has('sale_start_date') ? 'is-invalid' : ''}}" type="date" value="{{old('sale_start_date')}}" id="sale_start_date" name="sale_start_date">
                    ...
                    <div class="col">
                        ...
                        <input class="form-control {{ $errors->has('sale_end_date') ? 'is-invalid' : ''}}" type="date" value="{{old('sale_end_date')}}" id="sale_end_date" name="sale_end_date">
