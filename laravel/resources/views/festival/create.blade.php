            ...
            <form action="/festivals/" method="POST">
                ...
                <div class="form-row form-group">
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control {{ $errors->has('place') ? 'is-invalid' : ''}}" id="place" name="place" value="{{old('place')}}">
                        @if($errors->has('place'))
                            <div class="invalid-feedback">
                                {{$errors->first('place')}}
                            </div>
                ...
                <div class="form-row form-group">
                    <div class="col">
                        ...
                        <input type="text" class="form-control {{ $errors->has('facebook_url') ? 'is-invalid' : ''}}" id="facebook_url" name="facebook_url" value="{{old('facebook_url')}}">
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control {{ $errors->has('twitter_url') ? 'is-invalid' : ''}}" id="twitter_url" name="twitter_url" value="{{old('twitter_url')}}">
                ...
                <div class="form-row form-group">
                    <div class="col">
                        ...
                        <input type="text" class="form-control {{ $errors->has('instagram_url') ? 'is-invalid' : ''}}" id="instagram_url" name="instagram_url" value="{{old('instagram_url')}}">
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control {{ $errors->has('snapchat_url') ? 'is-invalid' : ''}}" id="snapchat_url" name="snapchat_url" value="{{old('snapchat_url')}}">
